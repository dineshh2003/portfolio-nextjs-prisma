...
const ProjectPage = forwardRef<HTMLElement>((props, ref) => {
  return (
    <section id="projects" ref={ref} className="relative h-auto w-full p-4 md:p-8">
      ...
      <div className="flex flex-col items-center">
        <div className="flex flex-col md:flex-row gap-8 justify-center w-full">
            ...
            <div  className="flex flex-col items-center bg-gray-100 p-4 rounded-2xl border border-gray-400 text-center flex-1 mx-4 md:mx-8 h-auto w-full md:w-96">
              ...
              <p text-gray-900 font-semibold text-m mb-4>This project is designed to facilitate remote patient monitoring, enabling healthcare providers to collect and analyze patient data in real-time. By leveraging machine learning models, this system aims to improve patient care by predicting health issues, optimizing treatment plans, and reducing hospital readmissions.</p>
              <div className="flex gap-4">
                <button className="bg-gray-200 text-black border border-gray-400 py-2 px-4 rounded-full">
                <a href="https://github.com/dineshh2003/Stellar-Med">
                        Github
                    </a>
                </button>
                <button className="bg-gray-200 text-black border border-gray-400 py-2 px-4 rounded-full">
            ...
            <div  className="flex flex-col items-center bg-gray-100 p-4 rounded-2xl border border-gray-400 text-center flex-1 mx-4 md:mx-8 h-auto w-full md:w-96">
              ...
              <p text-gray-900 font-semibold text-m mb-4> I developed a real-time chat application using Node.js, incorporating JWT tokens for robust authentication. This ensures secure user communication and data protection. The application supports one-on-one and group chats, featuring an intuitive user interface and reliable performance, making it a secure and user-friendly messaging solution.</p>
              <div className="flex gap-4">
                <button className="bg-gray-200 text-black border border-gray-400 py-2 px-4 rounded-full">
                  Github
                </button>
            ...
            {/* <div  className="flex flex-col items-center bg-gray-100 p-4 rounded-2xl border border-gray-400 text-center flex-1 mx-4 md:mx-8 h-auto w-full md:w-96">
              ...
              <h2 className="text-gray-900 font-semibold text-xl mb-4">Foodie</h2>
              <p text-gray-900 font-semibold text-m mb-4> I developed a real-time chat application using Node.js, incorporating JWT tokens for robust authentication. This ensures secure user communication and data protection. The application supports one-on-one and group chats, featuring an intuitive user interface and reliable performance, making it a secure and user-friendly messaging solution.</p>
              <div className="flex gap-4">
                <button className="bg-gray-200 text-black border border-gray-400 py-2 px-4 rounded-full">
                  Github
