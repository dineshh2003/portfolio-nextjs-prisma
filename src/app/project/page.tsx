...
const ProjectPage = () => {
  return (
    <section id="projects" className="relative h-auto w-full p-4 md:p-8 bg-gradient-to-r from-b2 to-b3 font-roboto">
      <div className="h-auto flex flex-col justify-center items-center mb-8">
        <p className="text-xl text-center mb-4 text-green">These are some of my work</p>
        <h1 className="text-5xl font-extrabold text-center mb-8 text-gray-400">Projects</h1>
      </div>
      <div className="flex flex-col items-center">
        <div className="flex flex-col md:flex-row gap-8 justify-center w-full">
          <div className="flex flex-col items-center bg-b3 p-4 rounded-2xl border border-gray-400 text-center flex-1 mx-4 md:mx-8 h-auto w-full md:w-96">
            ...
            <h2 className=" font-semibold text-xl mb-4 text-green">Rent-karo</h2>
            ...
            <div className="flex gap-4">
              <button className="bg-b3 border-gray-400 py-2 px-4 rounded-full text-green">
          ...
          <div className="flex flex-col items-center bg-b3 p-4 rounded-2xl border border-gray-400 text-center flex-1 mx-4 md:mx-8 h-auto w-full md:w-96">
            ...
            <h2 className="text-green font-semibold text-xl mb-1">STELLAR-MED</h2>
            <p className="text-gray-400 font-semibold text-m mb-4 ">
